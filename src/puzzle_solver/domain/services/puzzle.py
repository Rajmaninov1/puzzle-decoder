...
class PuzzleService:
    ...
    def __init__(self, fragment_service: FragmentService | None = None,
                 config: PuzzleServiceConfig | None = None) -> None:
    ...
    async def solve_puzzle(self, stream_threshold: int | None = None) -> PuzzleResult:
        """Solve a puzzle and return text, time, and stats."""
    ...
    def _assemble_puzzle_text(self, fragments: list, stream_threshold: int | None = None) -> str:
        """Assemble puzzle text with optional streaming for large datasets."""
    ...
    def _assemble_text_streaming(self, fragments: list) -> str:
        """Assemble text using streaming to reduce memory usage."""
    ...
    def _create_success_stats(self, batch_result: FragmentBatch, elapsed: float) -> PuzzleStats:
        """Create comprehensive statistics for successful puzzle solving."""
    ...
    @staticmethod
    def _create_error_result(error_message: str, elapsed: float) -> PuzzleResult:
        """Create error result."""
